    ...
    <div className={styles.footer} data-scroll-section>
      <div className={styles.wrapper}>
        ...
        <div className={styles.design}>
          Design by &nbsp;
          <Link className={styles.link} href="https://twitter.com/the_sagie">
            Sagie
          </Link>
        </div>
      </div>
